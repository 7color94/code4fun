...
'''
problem: https://2017.megcup.com/problems/7
'''

# Your token here
CONTEST_TOKEN = '892256d4dd64d406768af7574001ec8efb39e43aed6165b0dc9461ed5924028a'
PRACTICE_TOKEN = 'a8204295de1649cd0b5616dea34e93bfe8ce1004757fa867604d46dd4d652298'
...
class Sequence:
	...
	def my_query(self, index):
		print('my_query')
		i = index
		rst = self._get('/query/{}'.format(i))
		max_v = rst['data']['value']
		for j in xrange(0, int(math.sqrt(self.length))):
			k = randint(0, self.length - 1)
			rst = self._get('/query/{}'.format(k))
			#print(k, rst['data']['value'])
			if max_v < rst['data']['value'] and rst['data']['value'] <= self.target:
				i = k
				max_v = rst['data']['value']
		return i
